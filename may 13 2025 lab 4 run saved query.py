...
def run_query_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    phantom.act("run query", parameters=parameters, name="run_query_1", assets=["instructor es"], callback=format_2)
...
def add_note_2(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    phantom.add_note(container=container, content=format_3, note_format="markdown", note_type="general", title="List of high or critical")
...
def update_event_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    phantom.act("update event", parameters=parameters, name="update_event_1", assets=["instructor es"])
